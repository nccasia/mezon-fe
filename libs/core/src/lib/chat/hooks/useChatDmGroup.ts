...
export function useChatDmGroup(channelId: string | undefined) {
    ...
    const sendMessageDmGroup = React.useCallback(
    ...
    return useMemo(
        ...
        [client, messages, threads, members, unreadMessageId, lastMessageId, sendMessageDmGroup, createLinkInviteUser, inviteUser],
    );
}
