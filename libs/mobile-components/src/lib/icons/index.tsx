...
export function DiscoverySearchIcon({ width = 20, height = 20, ...props }: SvgProps) {
	return (
		<Svg width={width} height={height} viewBox="0 0 60 60" fill="none">
			<Path d="M54.2675 51.1217L40.785 37.6392C43.5075 34.1492 45 29.8867 45 25.3892C45 20.0467 42.9175 15.0242 39.14 11.2492C35.365 7.46916 30.3425 5.38916 25 5.38916C19.6575 5.38916 14.635 7.46916 10.86 11.2492C7.0825 15.0242 5 20.0467 5 25.3892C5 30.7317 7.0825 35.7542 10.86 39.5292C14.635 43.3092 19.6575 45.3892 25 45.3892C29.4975 45.3892 33.76 43.8992 37.25 41.1742L50.7325 54.6542L54.2675 51.1217ZM25 40.3892C20.9925 40.3892 17.2275 38.8292 14.395 35.9967C11.56 33.1642 10 29.3967 10 25.3892C10 21.3842 11.56 17.6167 14.395 14.7842C17.2275 11.9492 20.9925 10.3892 25 10.3892C29.0075 10.3892 32.7725 11.9492 35.605 14.7842C38.44 17.6167 40 21.3842 40 25.3892C40 29.3967 38.44 33.1642 35.605 35.9967C32.7725 38.8292 29.0075 40.3892 25 40.3892Z" fill="#484545" />
		</Svg>
...
export function BarsIcon({ width = 20, height = 20, color = "#4B4444", ...props }: SvgProps) {
	return (
		<Svg width={width} height={height} viewBox="0 0 46 36" fill="none">
			<Path fillRule="evenodd" clipRule="evenodd" d="M0.499512 3C0.499512 1.61929 1.6188 0.5 2.99951 0.5H42.9995C44.3802 0.5 45.4995 1.61929 45.4995 3C45.4995 4.38071 44.3802 5.5 42.9995 5.5H2.99951C1.6188 5.5 0.499512 4.38071 0.499512 3ZM0.499512 18C0.499512 16.6193 1.6188 15.5 2.99951 15.5H42.9995C44.3802 15.5 45.4995 16.6193 45.4995 18C45.4995 19.3807 44.3802 20.5 42.9995 20.5H2.99951C1.6188 20.5 0.499512 19.3807 0.499512 18ZM1.10556 33C1.10556 31.6193 2.22485 30.5 3.60556 30.5H42.3935C43.7742 30.5 44.8935 31.6193 44.8935 33C44.8935 34.3807 43.7742 35.5 42.3935 35.5H3.60556C2.22485 35.5 1.10556 34.3807 1.10556 33Z" fill={color} />
		</Svg>
	)
}

export function UserIcon({ width = 20, height = 20, ...props }: SvgProps) {
	return (
		<Svg width={width} height={height} viewBox="0 0 60 60" fill="none">
			<Path fillRule="evenodd" clipRule="evenodd" d="M34.9998 20.4984C34.9998 26.0109 30.5148 30.4984 24.9998 30.4984C19.4873 30.4984 14.9998 26.0109 14.9998 20.4984C14.9998 14.9859 19.4848 10.4984 24.9998 10.4984C30.5148 10.4984 34.9998 14.9859 34.9998 20.4984ZM4.99976 47.9984C4.99976 39.1659 13.2248 32.9984 24.9998 32.9984C36.7773 32.9984 44.9998 39.1659 44.9998 47.9984V50.4984H4.99976V47.9984Z" fill="#4E4949" />
			<Path d="M50 50.4982H55V47.9982C55 41.5914 50.674 36.5869 43.803 34.3212C47.655 37.7649 50 42.4979 50 47.9982V50.4982Z" fill="#4E4949" />
			<Path d="M37.2082 30.2521C41.664 29.2439 45 25.2521 45 20.4978C45 15.4058 41.173 11.1883 36.2425 10.5746C38.5802 13.2207 40 16.696 40 20.4978C40 24.1051 38.722 27.4184 36.5942 30.0084C36.8005 30.0874 37.0052 30.1686 37.2082 30.2521Z" fill="#4E4949" />
		</Svg>
	)
}