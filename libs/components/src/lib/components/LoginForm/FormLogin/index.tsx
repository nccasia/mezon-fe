    ...
    return (
        <div className="flex-col justify-start items-center flex w-[496px] h-fit gap-y-8 ">
            ...
            <div className="flex-col justify-start items-start flex w-full h-fit gap-y-5 ">
                <div className="flex-col justify-start items-start flex w-full h-fit gap-y-5 ">
                    <div className="flex-col justify-start items-start flex w-full h-fit gap-y-3 relative">
                        <div className="flex-row justify-start items-center flex w-full h-fit gap-x-1 ">
                            <p className="w-fit h-fit font-manrope text-left text-sm font-medium text-[#cccccc] leading-[150%]">Email or Phone number</p>
                        ...
                        <div className="flex-col justify-start items-start flex w-full h-fit ">
                            ...
                            >
                                <input
                                    ...
                                    className="w-full h-6 bg-transparent outline-0 border-[0] focus:outline-0 text-white "
                                    {...register("password")}
                                    name="password"
                                    id="password"
                ...
                <div className="flex-col justify-start items-start flex w-full h-fit">
                    <button onClick={handleFormSubmit} className="flex-col justify-start items-center flex w-full h-fit pt-3 pr-4 pb-3 pl-4 rounded-[4px] bg-[#155eef] ">
                        <p className="w-fit h-fit font-manrope text-left text-base font-medium text-[#ffffff] leading-[150%]">Sign in</p>
                    </button>
            ...
            <div>
                {errors.password && <AlertTitleTextWarning description={errors?.password?.message} />}
                {errors.userEmail && <AlertTitleTextWarning description={errors?.userEmail?.message} />}
            </div>
        </div>
    );
}
