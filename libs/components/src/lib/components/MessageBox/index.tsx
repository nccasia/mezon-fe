...
function MessageBox(props: MessageBoxProps): ReactElement {
  ...
  return (
    <div className="relative max-sm:-pb-2  ">
      ...
      >
        <div className={`absolute mt-[10px] z-10`}>
          <FileSelectionButton
        ...
        <div className={`w-full dark:bg-channelTextarea bg-channelTextareaLight gap-3 flex items-center rounded-e-md `}>
          <div
            className={`w-full dark:bg-channelTextarea bg-channelTextareaLight gap-3 relative whitespace-pre-wrap`}
        ...
        <div className={`absolute mt-[10px] z-10 right-0`}>
