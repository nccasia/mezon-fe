...
import { selectAllAccount, selectFriendStatus, selectMemberByUserId, selectMemberClanByUserId } from '@mezon/store';
...
const ModalUserProfile = ({
	...
	const memberById = useSelector(selectMemberClanByUserId(userID ?? ''));
