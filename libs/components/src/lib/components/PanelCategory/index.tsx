...
const PanelCategory: React.FC<IPanelCategoryProps> = ({coords, category, onDeleteCategory, setIsShowPanelChannel, setOpenSetting}) => {
	...
	const [hasClanManagerPermission] = useClanRestriction([EPermission.manageClan]);
	const hasManageCategoryPermission = isClanOwner || hasAdminPermission || hasClanManagerPermission;
