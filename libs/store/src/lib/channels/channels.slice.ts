...
export const joinChanel = createAsyncThunk("channels/joinChanel", async (channelId: string, thunkAPI) => {
    try {
        console.log("channelID-joined", channelId);
        ...
        // thunkAPI.dispatch(fetchChannels({ clanId: "00000000-0000-0000-0000-000000000000" }));
        // thunkAPI.dispatch(fetchCategories({ clanId: "00000000-0000-0000-0000-000000000000" }));
...
export const fetchChannels = createAsyncThunk("channels/fetchChannels", async ({ clanId }: fetchChannelsArgs, thunkAPI) => {
    const mezon = await ensureSession(getMezonCtx(thunkAPI));
...
// export const selectCurrentChannelDmGroup = (chId: string) => createSelector(selectEntities, (channelEntities) => channelEntities[chId]);
