import { EPermission, IRolesClan, LoadingStatus } from '@mezon/utils';
...
export const selectEveryoneRole = createSelector(selectAllRolesClan, (state)=>state.find(role=> role.slug === EPermission.everyone));
