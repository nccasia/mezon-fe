...
const MessageItem = React.memo(
	(props: MessageItemProps) => {
		...
		if (message.isStartedMessageGroup && message.sender_id == '0') return <WelcomeMessage channelId={props.channelId} />;
	...
	(prevProps, nextProps) => {
		return prevProps.messageId + prevProps?.message.update_time === nextProps.messageId + nextProps?.message.update_time;
	}
);
