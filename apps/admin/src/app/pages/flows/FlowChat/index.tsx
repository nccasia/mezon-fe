...
const FlowChatPopup = () => {
	return (
		<div className="text-sm text-gray-500 dark:text-gray-400 w-[350px]">
			<div className=" min-h-[300px] max-h-[400px] overflow-x-hidden overflow-y-auto [&::-webkit-scrollbar]:[width:3px] [&::-webkit-scrollbar-thumb]:bg-red-500 transition-all">
			...
			<div className="footer p-2 border-[1px] border-t-gray-400 relative">
				<input className="my-1 block w-full px-3 py-3 border-[1px] focus:border-[1px] focus:border-gray-500 focus-visible:border-[1px] focus:ring-0 focus-visible:border-gray-400 focus-within:ring-0 focus:ring-transparent rounded-lg" />
