import { channelsActions, clansActions, emojiSuggestionActions, recentEmojiSuggestionActions } from '@mezon/store';
...
export const clanLoader: CustomLoaderFunction = async ({ params, dispatch }) => {
	...
	dispatch(recentEmojiSuggestionActions.recentfetchEmoji({ clanId }));
	return {
		clanId
	} as ClanLoaderData;
};
