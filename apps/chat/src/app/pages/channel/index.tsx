...
export default function ChannelLayout() {
	...
	return (
		<>
			...
			<div
				className="flex flex-col flex-1 shrink min-w-0 bg-bgSecondary h-[100%] overflow-hidden z-0 border border-green-500"
				id="mainChat"
			...
			>
				<div className="flex h-heightWithoutTopBar flex-row ">
					<div className={`flex flex-col flex-1 w-full h-full ${closeMenu && !statusMenu && isShowMemberList && 'hidden'}`}>
							...
							<div
								className="overflow-y-auto w-[50rem] bg-[#1E1E1E] max-w-widthMessageViewChat overflow-x-hidden max-h-heightMessageViewChat h-heightMessageViewChat"
