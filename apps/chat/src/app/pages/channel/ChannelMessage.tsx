...
export function ChannelMessage({ messageId, type, channelId, mode, channelLabel, isHighlight }: Readonly<MessageProps>) {
  ...
  const popup = useMemo(() => {
    return <ChannelMessageOpt message={message} type={type} handleContextMenu={handleContextMenu} />;
